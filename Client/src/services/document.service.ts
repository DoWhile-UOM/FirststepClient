...
export class DocumentService {
  private apiUrl = 'https://firststepdowhile.azurewebsites.net/api/Document';
  private fetchUrl = 'https://firststepdowhile.azurewebsites.net/api/Document/GetSasToken';
