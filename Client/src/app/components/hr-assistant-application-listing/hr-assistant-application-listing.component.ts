...
@Component({
  selector: 'app-hr-assistant-application-listing',
  standalone: true,
  imports: [MatToolbar,MatIcon,MatLabel,MatInputModule,MatTableModule,MatFormFieldModule,MatSelectModule,CommonModule],
  templateUrl: './hr-assistant-application-listing.component.html',
  styleUrl: './hr-assistant-application-listing.component.css'
})
